        ...
        private static ExpressionData CompileExpression_MemberAccess (
            ...
            switch (parentExpr.Type->TypeTag) {
                ...
                case ES_TypeTag.Struct:
                    return CompileExpression_MemberAccess_Struct (ref passData, ref funcData, expr, parentExpr);

                case ES_TypeTag.Array:
                    return CompileExpression_MemberAccess_Array (ref passData, ref funcData, expr, parentExpr);

                case ES_TypeTag.Reference:
                    throw new CompilationException ("Reference types must be dereferenced manually before access.");
