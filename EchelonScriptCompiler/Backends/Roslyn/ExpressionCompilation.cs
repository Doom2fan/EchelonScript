...
public unsafe sealed partial class RoslynCompilerBackend {
    ...
    private static ExpressionSyntax CompileCode_NewArray (ES_ArrayTypeData* arrayType, ReadOnlySpan<ExpressionData> ranks, ExpressionSyntax? elemAssignValue) {
        ...
        /** Generate the function call **/
        var ret = InvocationExpression (MemberAccessExpression (
    ...
    private static ExpressionData CompileExpression (
        ...
        switch (expr.Kind) {
            ...
            // TODO: case ESIR_NodeKind.LiteralChar;
            ...
            case ESIR_NodeKind.LiteralNull when expr is ESIR_NullLiteralExpression nullLitExpr: {
                ...
                var value = nullType->TypeTag switch {
                    ES_TypeTag.Reference => LiteralExpression (SyntaxKind.NullLiteralExpression),
                    ES_TypeTag.Array => LiteralExpression (SyntaxKind.NullLiteralExpression),

                    _ => throw new CompilationException (ES_BackendErrors.FrontendError),
                };
            ...
            // TODO: case ESIR_NodeKind.StringConstant:
            ...
            // TODO: case ESIR_NodeKind.VirtualCallExpression:
