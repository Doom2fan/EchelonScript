...
internal ref partial struct CompileData {
    ...
    public ESC_TypeRef GetVoidType (ESC_Constness constness)
        => GetGlobalType (IdPool.GetIdentifier (ES_PrimitiveTypeConsts.Void), constness);

    public ESC_TypeRef GetBoolType (ESC_Constness constness)
        => GetGlobalType (IdPool.GetIdentifier (ES_PrimitiveTypeConsts.Bool), constness);
    ...
    public ESC_TypeRef GetFloat32Type (ESC_Constness constness)
        => GetGlobalType (IdPool.GetIdentifier (ES_PrimitiveTypeConsts.Float32), constness);

    public ESC_TypeRef GetFloat64Type (ESC_Constness constness)
        => GetGlobalType (IdPool.GetIdentifier (ES_PrimitiveTypeConsts.Float64), constness);
