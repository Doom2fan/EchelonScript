...
public enum ES_ObjectFlags : uint {
    ...
    /// <summary>The object is immutable.</summary>
    Immutable = 1 << 5,
...
public unsafe struct ES_ObjectAddress {
    public static ES_ObjectAddress Null {
    ...
    [MethodImpl (MethodImplOptions.AggressiveInlining)]
    internal ES_ObjectAddress (void* addr) => Address = addr;
...
public struct ES_ArrayIndex {
    ...
    [MethodImpl (MethodImplOptions.AggressiveInlining)]
    public static implicit operator ES_ArrayIndex (ES_ArrayIndexBase idx) => new () { Value = idx };
