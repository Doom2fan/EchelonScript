...
public class EchelonScriptStackUnderflowException : EchelonScriptException {
    public EchelonScriptStackUnderflowException (string message)
        : base (message) { }
}

public class EchelonScriptStackOverflowException : EchelonScriptException {
    public EchelonScriptStackOverflowException (string message)
        : base (message) { }
}

public class EchelonScriptStackCorruptionException : EchelonScriptException {
    public EchelonScriptStackCorruptionException (string message)
        : base (message) { }
}
