...
public static partial class ES_Utils {
    ...
    public static void AddRange (this ref StructPooledList<char> chars, ES_Utf8String str) {
        var enc = Encoding.UTF8;
        var strLen = enc.GetCharCount (str.Span);
        var outLen = enc.GetChars (str.Span, chars.AddSpan (strLen));

        Debug.Assert (outLen == strLen);
    }
}
