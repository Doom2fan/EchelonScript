    ...
    public partial class IRTest : UserControl {
        ...
        private unsafe string GetTypeName (ES_TypeInfo* type) {
            switch (type->TypeTag) {
                ...
                default: return $"{type->TypeTag.ToString ()} [NOT IMPLEMENTED]";
            }
        }
        private unsafe string GetString (ArrayPointer<byte> bytes) => bytes.GetPooledString (Encoding.ASCII);
